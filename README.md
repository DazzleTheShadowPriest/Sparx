...
1. Установите Tampermonkey или Violentmonkey.
   В Chrome или Edge откройте управление расширением Tampermonkey и включите Allow User Scripts / Разрешить пользовательские скрипты. Если переключатель отсутствует, откройте chrome://extensions или edge://extensions и включите Режим разработчика.
